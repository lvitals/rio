...
description = {
   summary = "Lua web framework with MVC architecture and RESTful API support (Development Version)",
...
build = {
   ...
   modules = {
      ...
      ["rio.testing.formatters.terminal"] = "lib/rio/testing/formatters/terminal.lua",
      ["rio.testing.reporter"] = "lib/rio/testing/reporter.lua",
      ["rio.testing.warning_registry"] = "lib/rio/testing/warning_registry.lua",
      ...
      ["rio.cli.shell"] = "lib/rio/cli/shell.lua",
      ...
      ["rio.cli.commands.test_command"] = "lib/rio/cli/commands/test_command.lua",
